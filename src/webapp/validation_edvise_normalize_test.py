...
def test_normalize_edvise_dataframe_to_pdp_returns_unchanged_for_empty_model_list() -> (
    None
):
...
def test_normalize_edvise_dataframe_to_pdp_returns_unchanged_for_non_student_course() -> (
    None
):
...
def test_normalize_edvise_dataframe_to_pdp_student_prefers_associates_over_certificate() -> (
    None
):
...
def test_normalize_edvise_dataframe_to_pdp_student_uses_empty_string_when_no_institution_identifier() -> (
    None
):
    ...
    out_df, _ = normalize_edvise_dataframe_to_pdp(
        df, ["STUDENT"], institution_identifier=None
    )
...
def test_normalize_edvise_dataframe_to_pdp_course_adds_institution_id_and_section_id() -> (
    None
):
    ...
    out_df, _ = normalize_edvise_dataframe_to_pdp(
        df, ["COURSE"], institution_identifier="inst-x"
    )
...
def test_normalize_edvise_dataframe_to_pdp_course_cohort_fill_from_academic_year() -> (
    None
):
...
def test_normalize_edvise_dataframe_to_pdp_course_cohort_fill_empty_when_no_academic_year() -> (
    None
):
...
def test_normalize_edvise_dataframe_to_pdp_adds_missing_schema_columns_when_schema_class_provided() -> (
    None
):
...
def test_normalize_edvise_dataframe_to_pdp_handles_schema_class_introspection_failure() -> (
    None
):
...
def test_normalize_edvise_dataframe_to_pdp_display_map_includes_renamed_and_added_columns() -> (
    None
):
